/*********************************************************************
This code modified to not use reset pin and I2C only
/*********************************************************************
...
Adafruit_SSD1306::Adafruit_SSD1306(int8_t dummy) : Adafruit_GFX(SSD1306_LCDWIDTH, SSD1306_LCDHEIGHT) {
  _isOn = false;
}
...
void Adafruit_SSD1306::on(bool on) {
  _isOn = on;
  ssd1306_command(on ? SSD1306_DISPLAYON : SSD1306_DISPLAYOFF);
}

bool Adafruit_SSD1306::isOn() {
  return _isOn;
}
